              ...
              <div class="row">
                  ...
                  <div class="col-lg-3 col-sm-12">
                      <div class="form-group">
                          ...
                          <select class="form-control {{ $errors->has('gender') ? ' is_invalid' : '' }}" id="gender" name="gender" class="list" value="{{ old('gender') }}" required>
                          <option value="">Select</option>
                  ...
                  <div class="col-lg-3 col-sm-12">
                      <div class="form-group">
                          ...
                          <select class="form-control {{ $errors->has('role') ? ' is_invalid' : '' }}" id="role" name="role" class="list" value="{{ old('role') }}" required>
                          <option value="">Select</option>
                  ...
                  <div class="col-lg-6 col-sm-12">
                      <div class="form-group">
                          ...
                          <input type="text" class="form-control {{ $errors->has('location') ? ' is_invalid' : '' }}" id="location" name="location" value="{{ old('location') }}" required>
                      </div>
                  </div>
