        ...
        <div class="container">
            ...
            <div class="row">
                @foreach($courses as $course)
                    <div class=" col-sm-6">
                        <div class="card text-center mt-3 " style="box-shadow: 5px 5px 10px gray">
                            <div class="card-header">
                                @if(Auth::User()->role === 'instructor')
                                    <ul class="nav nav-pills card-header-pills">
                                        <li class="nav-item">
                                            <span class="nav-link text-white {{ $course->is_active ? 'bg-success': 'bg-danger' }}" >{{ $course->is_active ? 'Activated Course': 'Deactivated Course' }}</span>
                                        </li>
