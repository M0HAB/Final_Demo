...
@section('content')
<<<<<<< HEAD
    <div id="response-message-success mb-3" class="alert alert-success" style="display: none"></div>
    ...
    <fieldset>
        <div class="reg-log-form p-3 my-3">
            <legend class="f-rw"><i class="fa fa-plus"></i> Add New Course</legend>
            <hr>
...
>>>>>>> ae0579850a7dc0228c7bf4a63220189d8476a5bc
                        </div>
                        <div class="form-group">
                            <label for="inputCode">Course Code</label>
                            <input type="text" name="code" class="form-control" id="inputCode" value="{{ Request::old('code')? : '' }}"  placeholder="Enter the course code">
