                ...
                <div class="card-body left-side-courseinfo-card">
                    ...
                    <ul class="list-group">
                        <li class="list-group-item list-group-item-custom d-flex justify-content-between align-items-center">
                            Name:
                            <span class="badge badge-pill badge-custom">Cousre 1</span>
                        </li>
                        <li class="list-group-item list-group-item-custom d-flex justify-content-between align-items-center">
                            Code:
                            <span class="badge badge-pill badge-custom">1234</span>
                        </li>
                        <li class="list-group-item list-group-item-custom d-flex justify-content-between align-items-center">
                            Department:
                            <span class="badge badge-pill badge-custom">Computer</span>
                        </li>
                        <li class="list-group-item list-group-item-custom d-flex justify-content-between align-items-center">
                                Language:
                                <span class="badge badge-pill badge-custom">English</span>
                        </li>
                        <li class="list-group-item list-group-item-custom d-flex justify-content-between align-items-center">
                            Start Date:
                            <span class="badge badge-pill badge-custom">2018-06-07</span>
                        </li>
                    </ul>
                  </div>
